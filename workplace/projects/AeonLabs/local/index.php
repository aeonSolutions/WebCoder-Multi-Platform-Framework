...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../resources/styles/mainpage.css" />
        <link rel="stylesheet" type="text/css" href="../resources/styles/pageheader.css" />
        ...
        <link rel="stylesheet" type="text/css" href="../resources/styles/timer.css" />
		<script type="text/javascript" src="../resources/browserdom/yepnope.js"></script>        
		<script type="text/javascript" src="../resources/browserdom/modernizr.custom.js"></script>
		<script type="text/javascript" src="../../../../system/browserdom/ajx-ini.js"></script>
		<script type="text/javascript" src="../../../../system/browserdom/elements.js"></script>
    ...
    <body>
		...
		<div id="flip" class="container">
			...
			<?php
			include('../../../../library/bookpages/loader.php');
			?>
		...
		<script type="text/javascript" src="../resources/browserdom/jquery-1.11.3.js"></script>
		<script type="text/javascript">
			...
			Modernizr.load({
				...
				yep : ['../resources/browserdom/jquery.tmpl.min.js','../resources/browserdom/jquery.history.js','../resources/browserdom/core.string.js','../resources/browserdom/jquery.touchSwipe-1.2.5.js','../resources/browserdom/jquery.flips.js'],
				nope: '../resources/styles/fallback.css',
				callback : function( url, result, key ) {
					
					if( url === '../resources/styles/fallback.css' ) {
						$pages.show();
					}
					else if( url === '../resources/browserdom/jquery.flips.js' ) {
						$container.flips();
					}
